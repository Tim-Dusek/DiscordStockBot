...
async def create_crypto_graph(ctx, crypto: str, period: str, units: int) -> None:
	try:
		...
		logging.error(f'Ran into an error trying to create a crypto graph! The error was: ' + e.with_traceback())
...
async def create_crypto_candlestick_graph(ctx, crypto: str, period: str, units: int) -> None:
	try:
		...
		logging.error(f'Ran into an error trying to create a crypto candlestick graph! The error was: ' + e.with_traceback())
	# End try/except block	
# End def
...
async def create_graph(ctx, company: str, interval: str, start=None, end=None, period=None, prepost=False) -> None:
	try:
		...
		logging.error(f'Ran into an error trying to create a graph! The error was: ' + e.with_traceback())
	# End try/except block
# End def
...
async def price(ctx, company: str) -> None:
	try:
		...
		logging.error(f'Ran into an error trying to get a price! The error was: ' + e.with_traceback())
...
async def whois(ctx, company: str) -> None:
	try:
		...
		logging.error(f'Ran into an error trying to get whois information! The error was: ' + e.with_traceback())
...
async def expert(ctx, company: str) -> None:
	try:
		...
		logging.error(f'Ran into an error trying to get expert opinions! The error was: ' + e.with_traceback())
		await ctx.send(f"Some returned data was incorrect for {company.upper()}!")
	# End try/except block
# End command
