...
async def help(ctx):
	try:
		...
		logging.info(f'{ctx.get_guild(731225595668856864).get_member(ctx.message.author.id)}')
		logging.info(f'{ctx.get_guild(731225595668856864).get_member(ctx.message.author.id).guild_permissions.administrator}')
		if ctx.get_guild(731225595668856864).get_member(ctx.message.author.id).guild_permissions.administrator:
